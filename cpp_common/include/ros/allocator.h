///////////////////////////////////////////////////////////////////////////////
//
// (C) Copyright Dariush Forouher 2014
...
typedef boost::interprocess::basic_managed_external_buffer<char,
			...
			boost::interprocess::iset_index> ros_managed_external_buffer;

template <typename value_type>
struct alloc
{
    typedef boost::interprocess::ros_allocator< value_type, ros_managed_external_buffer::segment_manager> type;
};
